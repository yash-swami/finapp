        ...
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-middle">
                ...
                <div class="uk-width-1-3@m uk-flex uk-flex-right uk-visible@m">
                    <span class="uk-margin-right"><img src="assets/img/in-lazy.gif" data-src="assets/img/in-footer-mastercard.svg" alt="footer-payment" width="34" height="21" data-uk-img=""></span>
                    <span><img src="assets/img/in-lazy.gif" data-src="assets/img/in-footer-visa.svg" alt="footer-payment" width="50" height="16" data-uk-img=""></span>
                </div>
            </div>
        </div>
    </div>
...
<!-- to top end -->
<!-- javascript -->
<script src="assets/js/vendors/tradingview-widget.min.js"></script>
