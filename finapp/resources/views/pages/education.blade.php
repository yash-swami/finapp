                ...
                <div class="uk-width-3-5@m">
                  <h1 class="uk-margin-remove"><span class="in-highlight">Knowledge</span> is a wise investment</h1>
                    ...
                    <span class="uk-label uk-border-rounded">
                      <i class="fas fa-book fa-sm uk-margin-small-right uk-visible@s"></i>Learn
                  </span>
                    <i class="fas fa-long-arrow-alt-right fa-sm uk-margin-small-left uk-margin-small-right"></i>
                    <span class="uk-label uk-border-rounded">
                      <i class="fas fa-lightbulb fa-sm uk-margin-small-right uk-visible@s"></i>Understand
                 </span>
                    <i class="fas fa-long-arrow-alt-right fa-sm uk-margin-small-left uk-margin-small-right"></i>
                    <span class="uk-label uk-border-rounded">
                      <i class="fas fa-chart-area fa-sm uk-margin-small-right uk-visible@s"></i>Trade
                  </span>                
                </div>
                    ...
                    <div class="uk-card uk-card-default uk-card-body uk-border-rounded">                    
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-expand@m">
                                <h3 class="uk-margin-remove-bottom">Trader Academy</h3>
                                <p class="uk-margin-small-top">Reprehenderit in voluptate velit esse cillum dolore laboris aute irure.</p>
                                <a class="uk-button uk-button-primary uk-border-rounded" href="#">Start Learning<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="uk-width-1-5@m uk-text-right@m">
                                    <a href="#" class="uk-button uk-button-text">Enter Course<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="uk-width-1-3@m">
