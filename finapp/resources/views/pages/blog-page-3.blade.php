                        ...
                        <div class="in-blog-1" data-uk-grid>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-media-top">
                                        <img src="img/user/image-featured-cHWUtS.jpg" alt="Here are 3 year-end strategies for high-net-worth families to consider">
                                    </div>
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/here-are-3-year-end-strategies-for-high-net-worth-families.html" class="link-primary text-decoration-none">Here are 3 year-end strategies for high-net-worth families to consider</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        ...
                                        <div class="uk-float-right">
                                            <a href="blog/here-are-3-year-end-strategies-for-high-net-worth-families.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/the-lastpass-disclosure-of-leaked-password-vaults-is.html" class="link-primary text-decoration-none">The LastPass disclosure of leaked password vaults is being torn apart by security experts</a>
                                        </h3>
                                        <p>Last week, just before Christmas, LastPass dropped a bombshell announcement: as the result of a breach in August, which lead to another breach in November, hackers had gotten their hands on users’ password vaults. While the company insists that your login information is still secure, some cybersecurity experts are heavily criticizing its post, saying that it could make people feel more secure than they actually are and pointing out that this is just the latest in a series of incidents that make it hard to trust the password manager.</p>
                                        <div class="uk-flex">
                                            <div class="uk-margin-small-right">
                                                <img class="uk-border-pill uk-background-muted" src="img/user/author-85z9UC.jpg" alt="image-team" width="32" height="32">
                                            </div>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        ...
                                        <div class="uk-float-right">
                                            <a href="blog/the-lastpass-disclosure-of-leaked-password-vaults-is.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/turf-houses-icelands-original-green-buildings.html" class="link-primary text-decoration-none">Turf houses: Iceland&#x27;s original &#x27;green&#x27; buildings</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        <div class="uk-float-left">
                                            <span class="uk-label uk-label-warning in-label-small">Travel</span>
                                        </div>
                                        <div class="uk-float-right">
                                            <a href="blog/turf-houses-icelands-original-green-buildings.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
