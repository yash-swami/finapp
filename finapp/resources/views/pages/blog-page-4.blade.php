                            ...
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/shortfalls-of-some-cold-and-flu-meds-continue-amid.html" class="link-primary text-decoration-none">Shortfalls of some cold and flu meds continue amid shifting respiratory virus season</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        ...
                                        <div class="uk-float-right">
                                            <a href="blog/shortfalls-of-some-cold-and-flu-meds-continue-amid.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
