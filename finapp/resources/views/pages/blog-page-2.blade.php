                        ...
                        <div class="in-blog-1" data-uk-grid>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-media-top">
                                        <img src="img/user/image-featured-S3bwOc.jpg" alt="Thinking of going vegan? What you need to know first">
                                    </div>
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/thinking-of-going-vegan-what-you-need-to-know-first.html" class="link-primary text-decoration-none">Thinking of going vegan? What you need to know first</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        <div class="uk-float-left">
                                            <span class="uk-label uk-label-warning in-label-small">Health</span>
                                        </div>
                                        <div class="uk-float-right">
                                            <a href="blog/thinking-of-going-vegan-what-you-need-to-know-first.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/a-defiant-move-to-the-norwegian-arctic.html" class="link-primary text-decoration-none">A defiant move to the Norwegian Arctic</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        ...
                                        <div class="uk-float-right">
                                            <a href="blog/a-defiant-move-to-the-norwegian-arctic.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="in-stretch">
                                <article class="uk-card uk-card-default uk-border-rounded">
                                    <div class="uk-card-body">
                                        <h3>
                                            <a href="blog/the-bidens-make-an-island-escape-ahead-of-consequential.html" class="link-primary text-decoration-none">The Bidens make an island escape ahead of consequential 2024 announcement</a>
                                        </h3>
                                    ...
                                    <div class="uk-card-footer uk-clearfix">
                                        ...
                                        <div class="uk-float-right">
                                            <a href="blog/the-bidens-make-an-island-escape-ahead-of-consequential.html" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
